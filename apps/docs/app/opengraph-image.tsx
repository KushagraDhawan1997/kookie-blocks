...
export const alt = "Kookie Blocks – Higher-Level Components for Kookie UI";
...
export default async function Image() {
  const title = "Kookie Blocks";
  const subtitle = "Higher-Level Components for Kookie UI";
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          Higher-Level Components for Kookie UI
        </div>
      </div>
    ),
    {
