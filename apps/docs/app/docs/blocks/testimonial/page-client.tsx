...
import { TestimonialExamples } from "./examples";
...
export default function TestimonialPageClient({ metadata }: TestimonialPageClientProps) {
  ...
  return (
    ...
    >
      {activeTab === "docs" ? <ContentMDX /> : <TestimonialExamples />}
    </SiteDocsPage>
  );
}
